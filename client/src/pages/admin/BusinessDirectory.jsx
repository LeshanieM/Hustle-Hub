                    ...
                    <div className="flex gap-2 w-full sm:w-auto overflow-x-auto pb-1 sm:pb-0 scrollbar-hide">
                        {['ALL', 'ACTIVE', 'PENDING_APPROVAL', 'SUSPENDED'].map(status => (
                            <button
                                ...
                                className={`px-5 py-2.5 rounded-xl text-xs font-black transition-all whitespace-nowrap border ${filterStatus === status
                        ...
                        <div key={biz._id} className="group relative bg-white rounded-[28px] border border-slate-100 p-6 shadow-sm hover:shadow-2xl hover:shadow-[#1111d4]/10 hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    {/* Status Pill */}
                                    <div className={`px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest shrink-0 shadow-sm border ${biz.status === 'ACTIVE' ? 'bg-emerald-50 text-emerald-600 border-emerald-100' :
                                ...
                                <div className="flex gap-3">
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 ${biz.status === 'ACTIVE'
