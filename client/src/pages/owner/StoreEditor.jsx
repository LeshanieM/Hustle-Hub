...
const StoreEditor = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const errorMsg =
        error.response?.data?.message || 'Failed to save store layout.';
      alert(errorMsg);
    }
    setIsSaving(false);
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f6f6f8] text-slate-900 font-sans">
      <OwnerHeader />
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && (
                      <span className="text-rose-500 text-[10px] uppercase font-bold mt-1 block px-1">
                        {errors.name}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col gap-3">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleFieldChange('banner', e.target.value)
                        }
                      ...
                      <div className="flex gap-4 items-center">
                        {storeData.logo ? (
                          <img
                            src={storeData.logo}
                            alt="Logo"
                            className="w-14 h-14 rounded-full object-cover border-2 border-slate-200 shadow-sm bg-slate-50 flex-shrink-0"
                          />
                        ) : (
              ...
              <div className="h-12 bg-slate-100 border-b border-slate-200 flex items-center px-4 gap-4 flex-shrink-0">
                ...
                <div className="flex-1 max-w-sm mx-auto bg-white border border-slate-200 rounded-md py-1 px-4 text-center">
                  <span className="text-xs text-slate-400 font-medium">
                    <span className="material-symbols-outlined text-[10px] mr-1 inline-block align-middle">
                      lock
                    </span>
                    hustlehub.com/store/
                ...
                <header className="px-8 py-5 flex items-center justify-between border-b border-slate-200 bg-white shadow-sm shrink-0">
                  <div className="flex items-center gap-4">
                    ...
                    <span
                      ...
                      style={{ color: storeData.primaryColor || '#051094' }}
                    >
                ...
                <div className="relative h-[400px] shrink-0 bg-slate-100 flex flex-col items-center justify-center text-center px-6 overflow-hidden">
                  {storeData.banner ? (
                    ...
                    <div
                      ...
                      style={{
                        background: `linear-gradient(135deg, ${storeData.primaryColor || '#1111d4'}, #000000)`,
                      }}
                    ></div>
                  )}
                  ...
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 opacity-80">
                      {[
                        ...
                        <div
                          key={item.id}
                          className="bg-white p-4 rounded-3xl border border-slate-200 relative group overflow-hidden"
                        >
                          <div
                            className={`aspect-[4/5] bg-slate-100 rounded-2xl mb-4 relative overflow-hidden ${item.stock === 'out_of_stock' ? 'opacity-80 grayscale' : ''}`}
                          >
                            ...
                            <div
                              className={`absolute top-2 left-2 px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider ${item.color} z-10 shadow-sm flex items-center gap-1 backdrop-blur-sm`}
                            >
