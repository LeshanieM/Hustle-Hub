                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder-slate-400"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStoreData(prev => ({ ...prev, contactInfo: e.target.value }))}
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder-slate-400"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <input
                                            ...
                                            value={storeData.primaryColor || '#1111d4'}
                                            onChange={(e) => setStoreData(prev => ({ ...prev, primaryColor: e.target.value }))}
                                            className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all uppercase"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setStoreData(prev => ({ ...prev, headline: e.target.value }))}
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none placeholder-slate-400"
                                        rows="2"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setStoreData(prev => ({ ...prev, subheadline: e.target.value }))}
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium text-slate-600 focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none placeholder-slate-400"
                                        rows="3"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setStoreData(prev => ({ ...prev, ctaText: e.target.value }))}
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder-slate-400"
                                ...
                                <div className="space-y-2">
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setStoreData(prev => ({ ...prev, banner: e.target.value }))}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs font-medium text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder-slate-400"
                                ...
                                <div className="space-y-2">
                                    <div className="flex flex-col gap-3">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setStoreData(prev => ({ ...prev, logo: e.target.value }))}
                                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs font-medium text-slate-900 focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder-slate-400"
                                    ...
                                    <div className="grid grid-cols-4 gap-6 opacity-60">
                                        {[1, 2, 3, 4].map(i => (
                                            <div key={i} className="bg-white p-4 rounded-3xl border border-slate-200">
                                                <div className="aspect-[4/5] bg-slate-100 rounded-2xl mb-4"></div>
